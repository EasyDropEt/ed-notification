...
class MongoGenericRepository(Generic[TEntity], ABCGenericRepository[TEntity]):
    ...
    def get(self, **filters: Any) -> TEntity | None:
        ...
        raise ApplicationException(
            ...
            message=f"{self._collection} not found",
            errors=[f"{self._collection} with {filters} not found."],
        )
